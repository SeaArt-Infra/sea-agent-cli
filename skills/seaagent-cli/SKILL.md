...
bypass this approval step.
When running inside Codex or another agent-managed terminal, do not answer CLI
confirmation prompts yourself. Prepare the payload, show the exact command, and
ask the user to run the register/update command in their own terminal.
